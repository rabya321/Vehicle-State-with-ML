...
class TransformerRegressor(nn.Module):
    def __init__(self, input_size, d_model, nhead, num_encoder_layers, output_size, dropout=0.2):
    ...
    def forward(self, x):
        ...
        # Use the last token for prediction (like LSTM's last output)
...
model = TransformerRegressor(input_size, d_model, nhead, num_encoder_layers, output_size, dropout)
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Learning Curve - Transformer Model')
plt.legend()
plt.grid(True)
plt.show()
...
plt.plot(pred_pos_x, pred_pos_y, label='Predicted (Transformer)', linestyle='--', color='orange')
plt.xlabel('X (m)')
plt.ylabel('Y (m)')
plt.title('Predicted vs Actual Trajectory - Transformer Model')
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.tight_layout()
plt.savefig("Transformer_Trajectory_full")
plt.show()
...
plt.title('Positional Error over Time - Transformer Model')
plt.grid(True)
plt.show()
plt.savefig("Transformer_Positional_Error_over_Time")
...
plt.plot(pred_pos_x, pred_pos_y, label='Predicted (30s) - Transformer', linestyle='--', color='orange')
plt.xlabel('X (m)')
plt.ylabel('Y (m)')
plt.title('Trajectory Reconstruction for First 30 Seconds - Transformer')
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.tight_layout()
plt.savefig("Transformer_Trajectory_30s")
plt.show()
...
plt.title('Positional Error Over 30 Seconds - Transformer')
plt.grid(True)
plt.tight_layout()
plt.savefig("Transformer_Trajectory_Error_30s")
plt.show()
...
plt.plot(pred_pos_x, pred_pos_y, label='Predicted (60s) - Transformer', linestyle='--', color='orange')
plt.xlabel('X (m)')
plt.ylabel('Y (m)')
plt.title('Trajectory Reconstruction for First 60 Seconds - Transformer')
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.tight_layout()
plt.savefig("Transformer_Trajectory_60s")
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Euclidean Distance Error (m)')
plt.title('Positional Error Over 60 Seconds - Transformer')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("Transformer_Trajectory_Error_60s")
plt.show()
...
plt.plot(pred_pos_x, pred_pos_y, label='Predicted (5 min) - Transformer', linestyle='--', color='orange')
plt.xlabel('X (m)')
plt.ylabel('Y (m)')
plt.title('Trajectory Reconstruction for First 5 Minutes - Transformer')
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.tight_layout()
plt.savefig("Transformer_Trajectory_5min")
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Euclidean Distance Error (m)')
plt.title('Positional Error Over 5 Minutes - Transformer')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("Transformer_Trajectory_Error_5min")
plt.show()